...
class ExistedItemDBQuery {
  ...
  static initDB() async {
    ...
    return await openDatabase(path, version: 1, onCreate: (db, version) async {
      await db.execute(
          "CREATE TABLE ExistedItems(id INTEGER PRIMARY KEY , name TEXT , count INTEGER, bundle INTEGER ,price INTEGER, isNeeded INTEGER , isExpendables INTEGER , broadLocation TEXT,  narrowLocation TEXT,  detailLocation TEXT, note TEXT,sort TEXT, isUsing INTEGER)");
  ...
  static Future<List<ExistedItemModel>> getExistedItemDB(
      ExistedItemModel existedItem) async {
    final db = await database;
